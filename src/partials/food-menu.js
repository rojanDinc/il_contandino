...
export default () => (
  <div className="columns">
    ...
    <div className="column">
      <p className="p-5">På Restaurang Mama Rosa serverar vi rätter med autentiska smaker gjorda av noggrant utvalda färska ingredienser, modern matlagningsteknik och kortlivad hantverk. Genom att kombinera den unika mat- och dryckupplevelsen med en varm och personlig service vill vi bjuda in dig till oförglömliga, inspirerande och avkopplande möten, människor och mat.</p>
